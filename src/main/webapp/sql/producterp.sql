...
Date: 2017-07-19 10:13:20
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for data_collection
-- ----------------------------
...
CREATE TABLE `data_collection` (
  ...
  `canBookCount` int(11) DEFAULT NULL,
...
-- ----------------------------
-- Records of data_collection
-- ----------------------------
INSERT INTO `data_collection` VALUES ('160', 'W3770-粉红色-L', 'W3770', '15', 'https://detail.1688.com/offer/546155842720.html', '粉红色', 'L', 'https://cbu01.alicdn.com/img/ibank/2017/636/892/3966298636_1619311604.jpg', '2997', '2', '27', '0.25', '套', '4', '2017-05-03 14:04:19');
INSERT INTO `data_collection` VALUES ('161', 'W3770-粉红色-XL', 'W3770', '15', 'https://detail.1688.com/offer/546155842720.html', '粉红色', 'XL', 'https://cbu01.alicdn.com/img/ibank/2017/636/892/3966298636_1619311604.jpg', '2992', '2', '27', '0.25', '套', '4', '2017-05-03 14:04:19');
...
INSERT INTO `navigator` VALUES ('63', 'navigator.shopee.area', 'Shopee 专区', null, 'icon-shopping-cart', '1', '0', '4');
INSERT INTO `navigator` VALUES ('64', 'shopee.publish.manage', '刊登管理', '/shopee/shopeePublishManage', 'icon-table', '0', '63', null);
INSERT INTO `navigator` VALUES ('65', 'shopee.category.manage', '类别管理', '/shopee/shopeeCategoryManage', 'icon-bars', '0', '63', null);
INSERT INTO `navigator` VALUES ('66', 'collection.center', '采集中心', null, 'icon-cloud-download', '1', '0', '3');
INSERT INTO `navigator` VALUES ('67', 'collection.data', '数据采集', '/dataCollection/dataCollectionManage', 'icon-stack', '0', '66', null);
INSERT INTO `navigator` VALUES ('70', 'platform.site.config', '平台与站点设置', '/system/platformSiteManage', 'icon-branch', '0', '46', null);
INSERT INTO `navigator` VALUES ('71', 'publish.user.distribution', '刊登人分配配置', '/system/publishUserDistributeManage', 'icon-hand-right', '0', '46', null);
...
-- ----------------------------
INSERT INTO `navigator_user` VALUES ('17', '7', '57');
INSERT INTO `navigator_user` VALUES ('18', '7', '58');
INSERT INTO `navigator_user` VALUES ('19', '4', '48');
INSERT INTO `navigator_user` VALUES ('20', '4', '49');
INSERT INTO `navigator_user` VALUES ('21', '4', '57');
INSERT INTO `navigator_user` VALUES ('22', '4', '58');
INSERT INTO `navigator_user` VALUES ('23', '3', '48');
INSERT INTO `navigator_user` VALUES ('24', '3', '49');
INSERT INTO `navigator_user` VALUES ('25', '3', '57');
INSERT INTO `navigator_user` VALUES ('26', '3', '58');

-- ----------------------------
-- Table structure for platform_site
-- ----------------------------
DROP TABLE IF EXISTS `platform_site`;
CREATE TABLE `platform_site` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `platformId` int(11) DEFAULT NULL,
  `currencyId` int(11) DEFAULT NULL,
  `language` varchar(255) DEFAULT NULL,
  `siteNameCn` varchar(255) DEFAULT NULL,
  `siteNameEn` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of platform_site
-- ----------------------------
INSERT INTO `platform_site` VALUES ('2', '10', '4', 'en', '亚马逊德国', 'Amazon-DE');
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('17', 'DV3', 'Y2639', '照片', 'photo', null, null, null, null, null, '电子相册', 'e-photo', 'http://www.guphotos.com/images/D/D1816W-EU/D1816W-EU-4-375a.jpg', '15.3', null, null, '2', '3', '4', '5', null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'http://www.guphotos.com/images/D/D1816W-EU/D1816W-EU-4-375a.jpg', '1: 【于 2016-12-28 23:18:37 由 王单爆 操作, 创建了商品信息】<br/>2: 【于 2017-01-05 10:02:06 由 王单爆 操作, 修改了商品信息】<br/>3: 【于 2017-01-05 15:16:28 由 玄奘-员工 操作, 修改了商品信息】<br/>4: 【于 2017-01-05 16:08:45 由 王单爆 操作, 修改了商品信息】<br/>5: 【于 2017-01-18 17:49:32 由 王单爆 操作, 修改了商品信息】<br/>6: 【于 2017-01-20 18:21:30 由 玄奘-员工 操作, 修改了商品信息】<br/>7: 【于 2017-01-20 18:22:14 由 玄奘-员工 操作, 修改了商品信息】', '2', '4', '2', '10', '2016-12-28 23:18:37', '2017-01-20 18:22:14', 'XMt', '红色', '123');
INSERT INTO `product` VALUES ('18', 'Y2639BL', 'Y2639', 'CAMP607移动式侧板滑轮', 'Lixada 20KN Small Mobile Single Pulley Swing Side Climbing Rigging Rescue', '', 'Lixada 20KN kleine mobile Einzel Pulley Schaukel Side Kletter Rigging-Rettung', 'リギングレスキュークライミングLixada 20KN小型モバイルシングルプーリースイングサイド', 'Lixada 20KN Piccolo mobile singolo puleggia oscillazione laterale arrampicata Rigging Rescue', 'Lixada 20KN Pequeño móvil polea simple swing Escalada Aparejo Rescate Side', '移动式侧板滑轮', 'Mobile Single Pulley', 'http://www.guphotos.com/images/Y/L/Y2639BL/Y2639BL-1-d704-oYyw.jpg', '12.99', '', '', '1', '3', '4', '7', '', 'Hot up your summer collection with this alluring bikini set. It has vintage floral print, off the shoulder top and flattering low-rise bottom. A definite lust worthy piece that will turn heads like no other on beach.<br />\n<br />\n&nbsp;', 'Hot votre collection d&amp;#39;&eacute;t&eacute; avec cet ensemble de bikini s&eacute;duisant. Il a imprim&eacute; floral vintage, du haut de l&amp;#39;&eacute;paule et en bas de faible hauteur flatteur. Une convoitise pi&egrave;ce digne d&eacute;finitive qui fera tourner les t&ecirc;tes comme aucun autre sur la plage.<br />\n&nbsp;', 'Hot up Ihre Sommer-Kollektion mit diesem verf&uuml;hrerischen Bikini-Set. Es hat Jahrgang Blumendruck, weg von der Schulter oben und schmeichelnd Flachbau unten. Eine definitive Lust w&uuml;rdig St&uuml;ck, die K&ouml;pfe wie kein anderer am Strand verwandeln wird.<br />\n&nbsp;', 'ホットアップこの魅力的なビキニセットであなたの夏のコレクション。これは、肩の上部と世辞低層の底から、ヴィンテージの花柄を持っています。ビーチで他に類をみない頭を向けるだろう明確な欲望に値する作品。<br />\n&nbsp;', 'Hot la vostra collezione estiva con questo set bikini seducente. Ha stampa floreale d&amp;#39;epoca, fuori dalla parte superiore della spalla e lusinghiero in basso a vita bassa. Decisamente un desiderio degno pezzo che non passa inosservato come nessun altro sulla spiaggia.<br />\n&nbsp;', 'Caliente hasta su colecci&oacute;n de verano con este conjunto de bikini atractivo. Tiene la impresi&oacute;n floral de la vendimia, de la parte superior del hombro y favorecedor parte inferior de poca altura. Un deseo definitivo pieza digna que har&aacute; girar las cabezas como ning&uacute;n otro en la playa.<br />\n&nbsp;', '', '', '', '', '', '', '', 'http://www.guphotos.com/images/Y/L/Y2639BL/Y2639BL-1-d704-KP3L.jpg', '1: 【于 2017-01-06 09:45:22 由 李四-主管 操作, 创建了商品信息】<br/>2: 【于 2017-01-10 14:11:26 由 王单爆 操作, 修改了商品信息】<br/>3: 【于 2017-01-10 14:12:25 由 王单爆 操作, 修改了商品信息】<br/>4: 【于 2017-01-10 18:33:49 由 王单爆 操作, 修改了商品信息】<br/>5: 【于 2017-01-11 12:29:15 由 王单爆 操作, 修改了商品信息】<br/>6: 【于 2017-01-20 17:12:28 由 玄奘-员工 操作, 修改了商品信息】<br/>7: 【于 2017-01-20 18:11:05 由 玄奘-员工 操作, 修改了商品信息】<br/>8: 【于 2017-01-20 18:12:52 由 玄奘-员工 操作, 修改了商品信息】<br/>9: 【于 2017-01-20 18:15:33 由 玄奘-员工 操作, 修改了商品信息】<br/>10: 【于 2017-01-20 18:16:00 由 王单爆 操作, 修改了商品信息】<br/>11: 【于 2017-01-20 18:20:31 由 玄奘-员工 操作, 修改了商品信息】<br/>12: 【于 2017-01-20 18:20:44 由 玄奘-员工 操作, 修改了商品信息】', '3', '4', '2', '10', '2017-01-06 09:45:22', '2017-01-20 18:20:44', 'XL12', '蓝色', null);
INSERT INTO `product` VALUES ('25', 'W3770-X', 'W3770', '路亚硬饵 DW21 夜光白 熊王系列长舌板 64mm 16.5g', 'Lures hard bait luminous polar bear king DW21 series tongued plate 64mm 16.5g', '', '', '', '', '', '23', '12', '', null, '', '', null, null, null, null, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'https://www.guphotos.com/images/H/H10596W/H10596W-7-04e1.jpg', '1: 【于 2017-01-21 14:14:10 由 王单爆 操作, 创建了商品信息】<br/>2: 【于 2017-02-18 14:38:17 由 王单爆 操作, 修改了商品信息】<br/>3: 【于 2017-03-06 18:15:24 由 王单爆 操作, 修改了商品信息】<br/>4: 【于 2017-03-06 18:29:14 由 王单爆 操作, 修改了商品信息】', '2', null, '2', '5', '2017-01-21 14:14:10', '2017-03-06 18:29:14', '64mm', '夜光白', null);
INSERT INTO `product` VALUES ('26', 'W3770-T', 'W3770', '路亚硬饵 DW21 喷红头 熊王系列长舌板 64mm 16.5g', 'Road sub bait hard DW21 bear spray red king Series tongued plate 64mm 16.5g', '', '', '', '', '', '23', '12', '', null, '', '', null, null, null, null, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'https://www.guphotos.com/images/H/H10596P/H10596P-5-7cf0.jpg', '1: 【于 2017-01-21 14:14:10 由 王单爆 操作, 创建了商品信息】<br/>2: 【于 2017-01-21 14:14:42 由 王单爆 操作, 修改了商品信息】<br/>3: 【于 2017-01-21 14:26:54 由 王单爆 操作, 修改了商品信息】<br/>4: 【于 2017-02-18 14:37:58 由 王单爆 操作, 修改了商品信息】<br/>5: 【于 2017-03-06 18:14:16 由 王单爆 操作, 修改了商品信息】<br/>6: 【于 2017-03-06 18:27:36 由 王单爆 操作, 修改了商品信息】<br/>7: 【于 2017-03-06 18:28:08 由 王单爆 操作, 修改了商品信息】', '2', null, '2', '5', '2017-01-21 14:14:10', '2017-03-06 18:28:08', '64mm', '喷红头', null);
INSERT INTO `product` VALUES ('27', 'W3770-23', 'W3770', '路亚硬饵 DW21 黑红色 熊王系列长舌板 64mm 16.5g', 'Lures hard bait red black bear king DW21 series tongued plate 64mm 16.5g', 'Leurres appâts dur rouge série DW21 noir roi ours plaque tongued 64mm 16.5g', 'Lockt harten Köder rot schwarzer Bär König DW21 Serie tongued Platte 64mm 16.5g', 'ハード餌赤、黒クマ王のDW21シリーズ舌プレート64ミリメートルの16.5グラムルアー', 'Esca dura attira rosso nero orso re serie DW21 piatto dalla lingua 64 millimetri 16.5g', 'Señuelos cebo duro rojo serie DW21 rey oso negro placa de machihembrado 16,5 g 64mm', '路亚硬饵 DW21 黑红色 熊王系列长舌板 64mm 16.5g', 'Lures hard bait red black bear king DW21 series tongued plate 64mm 16.5g', '', '18', '12225651', '', '3', '1.2', '2', '3.7', '<strong>Caract&eacute;ristiques :</strong><br />\nMini manivelle p&ecirc;che leurre avec 3D vives de le &oelig;il et r&eacute;aliste natation action pour provoquer le pr&eacute;dateur &agrave; mordre.<br />\nplusieurs petites boules de m&eacute;tal dans le corps seront fait entendre quand faites glisser qui peuvent &ecirc;tre attir&eacute;s par l&#39;attention du poisson. Pendant ce temps, am&eacute;lioration de la distance de cast et de la stabilit&eacute; posturale.<br />\nplaque grande langue ultra-mince, capable de fonctionner le plus rus&eacute; z mot ex&eacute;cuter d&#39;action. Avec 2 VMC de<br />\nhame&ccedil;on triple, tr&egrave;s forte et durable.<br />\npaquet exquis, facile &agrave; stocker et &agrave; transporter.<br />\nappropri&eacute; pour diff&eacute;rentes excursions, outil merveilleux de p&ecirc;che pour les amateurs de p&ecirc;che.<br />\n<br />\n<strong>Sp&eacute;cifications :</strong><br />\nmarque : Trulinoya<br />\nABS: DW21<br />\ncrochets mod&egrave;le: 4 # VMC<br />\nprofondeur de plong&eacute;e: env. 2,5-3,2 m / 8,2-10,5 ft<br />\nlongueur de point: env. 6,4 cm/2,5 po<br />\npoint poids: env. 16,5 g/0,3 oz<br />\n&nbsp;', '<strong>Caract&eacute;ristiques :</strong><br />\nMini manivelle p&ecirc;che leurre avec 3D vives de le &oelig;il et r&eacute;aliste natation action pour provoquer le pr&eacute;dateur &agrave; mordre.<br />\nplusieurs petites boules de m&eacute;tal dans le corps seront fait entendre quand faites glisser qui peuvent &ecirc;tre attir&eacute;s par l&#39;attention du poisson. Pendant ce temps, am&eacute;lioration de la distance de cast et de la stabilit&eacute; posturale.<br />\nplaque grande langue ultra-mince, capable de fonctionner le plus rus&eacute; z mot ex&eacute;cuter d&#39;action. Avec 2 VMC de<br />\nhame&ccedil;on triple, tr&egrave;s forte et durable.<br />\npaquet exquis, facile &agrave; stocker et &agrave; transporter.<br />\nappropri&eacute; pour diff&eacute;rentes excursions, outil merveilleux de p&ecirc;che pour les amateurs de p&ecirc;che.<br />\n<br />\n<strong>Sp&eacute;cifications :</strong><br />\nmarque : Trulinoya<br />\nABS: DW21<br />\ncrochets mod&egrave;le: 4 # VMC<br />\nprofondeur de plong&eacute;e: env. 2,5-3,2 m / 8,2-10,5 ft<br />\nlongueur de point: env. 6,4 cm/2,5 po<br />\npoint poids: env. 16,5 g/0,3 oz<br />\n&nbsp;', '', '', '', '', '', '', '', '', '', '', '', '', 'https://www.guphotos.com/images/H/H10596R/H10596R-4-6290.jpg', '1: 【于 2017-01-21 14:14:10 由 王单爆 操作, 创建了商品信息】<br/>2: 【于 2017-02-18 14:37:38 由 王单爆 操作, 修改了商品信息】<br/>3: 【于 2017-03-06 18:13:11 由 王单爆 操作, 修改了商品信息】<br/>4: 【于 2017-03-06 18:25:44 由 王单爆 操作, 修改了商品信息】<br/>5: 【于 2017-05-12 15:37:12 由 王单爆 操作, 修改了商品信息】<br/>6: 【于 2017-05-12 15:37:21 由 王单爆 操作, 修改了商品信息】<br/>7: 【于 2017-05-12 15:37:44 由 王单爆 操作, 修改了商品信息】<br/>8: 【于 2017-05-12 15:37:52 由 王单爆 操作, 修改了商品信息】<br/>9: 【于 2017-05-12 15:38:26 由 王单爆 操作, 修改了商品信息】<br/>10: 【于 2017-05-12 15:38:33 由 王单爆 操作, 修改了商品信息】<br/>11: 【于 2017-05-12 15:38:48 由 王单爆 操作, 修改了商品信息】<br/>12: 【于 2017-05-12 15:47:11 由 王单爆 操作, 修改了商品信息】', '2', null, '2', '5', '2017-01-21 14:14:10', '2017-05-12 15:47:11', '64mm', '红色', null);
INSERT INTO `product` VALUES ('28', 'W3770-A', 'W3770-A', '路亚硬饵 DW21 黑红色 熊王系列长舌板 64mm 16.5g', 'Lures hard bait red black bear king DW21 series tongued plate 64mm 16.5g', 'Leurres appâts dur rouge série DW21 noir roi ours plaque tongued 64mm 16.5g', 'Lockt harten Köder rot schwarzer Bär König DW21 Serie tongued Platte 64mm 16.5g', 'ハード餌赤、黒クマ王のDW21シリーズ舌プレート64ミリメートルの16.5グラムルアー', 'Esca dura attira rosso nero orso re serie DW21 piatto dalla lingua 64 millimetri 16.5g', 'Señuelos cebo duro rojo serie DW21 rey oso negro placa de machihembrado 16,5 g 64mm', '路亚硬饵 DW21 黑红色 熊王系列长舌板 64mm 16.5g', 'Lures hard bait red black bear king DW21 series tongued plate 64mm 16.5g', '', '18', '', '', '3', '1.2', '2', '3.7', 'CADeN 可折叠牛津布内胆包 单反相机内胆包 小号', '<strong>Caract&eacute;ristiques :</strong><br />\nMini manivelle p&ecirc;che leurre avec 3D vives de le &oelig;il et r&eacute;aliste natation action pour provoquer le pr&eacute;dateur &agrave; mordre.<br />\nplusieurs petites boules de m&eacute;tal dans le corps seront fait entendre quand faites glisser qui peuvent &ecirc;tre attir&eacute;s par l&#39;attention du poisson. Pendant ce temps, am&eacute;lioration de la distance de cast et de la stabilit&eacute; posturale.<br />\nplaque grande langue ultra-mince, capable de fonctionner le plus rus&eacute; z mot ex&eacute;cuter d&#39;action. Avec 2 VMC de<br />\nhame&ccedil;on triple, tr&egrave;s forte et durable.<br />\npaquet exquis, facile &agrave; stocker et &agrave; transporter.<br />\nappropri&eacute; pour diff&eacute;rentes excursions, outil merveilleux de p&ecirc;che pour les amateurs de p&ecirc;che.<br />\n<br />\n<strong>Sp&eacute;cifications :</strong><br />\nmarque : Trulinoya<br />\nABS: DW21<br />\ncrochets mod&egrave;le: 4 # VMC<br />\nprofondeur de plong&eacute;e: env. 2,5-3,2 m / 8,2-10,5 ft<br />\nlongueur de point: env. 6,4 cm/2,5 po<br />\npoint poids: env. 16,5 g/0,3 oz<br />\n&nbsp;', '', '', '', '', '', '', '', '', '', '', '', '', 'https://www.guphotos.com/images/D/D2262S/D2262S-5-b005.jpg', '1: 【于 2017-01-21 14:14:10 由 王单爆 操作, 创建了商品信息】<br/>2: 【于 2017-02-18 14:37:38 由 王单爆 操作, 修改了商品信息】<br/>3: 【于 2017-03-06 18:13:11 由 王单爆 操作, 修改了商品信息】<br/>4: 【于 2017-03-06 18:25:44 由 王单爆 操作, 修改了商品信息】<br/>5: 【于 2017-03-21 17:26:38 由 王单爆 操作, 修改了商品信息】<br/>6: 【于 2017-03-21 17:27:32 由 王单爆 操作, 修改了商品信息】<br/>7: 【于 2017-04-22 15:19:27 由 王单爆 操作, 修改了商品信息】', '2', null, '2', '5', '2017-01-21 14:14:10', '2017-04-22 15:19:27', '64mm', '红色', null);
INSERT INTO `product` VALUES ('38', 'W3770-粉红色-XL', 'W3770', null, null, null, null, null, null, null, null, null, 'https://detail.1688.com/offer/546155842720.html', '27', null, null, '0.25', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'https://cbu01.alicdn.com/img/ibank/2017/636/892/3966298636_1619311604.jpg', '1: 【于 2017-05-06 15:06:39 由 王单爆 操作, 通过数据采集，移送到产品中心】', '2', null, null, '5', '2017-05-06 15:06:39', null, 'XL', '粉红色', null);
INSERT INTO `product` VALUES ('39', 'W3770-粉红色-L', 'W3770', '泳衣', '泳衣', null, null, null, null, null, '泳衣', '泳衣', 'https://detail.1688.com/offer/546155842720.html', '27', null, null, '0.25', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'https://cbu01.alicdn.com/img/ibank/2017/636/892/3966298636_1619311604.jpg', '1: 【于 2017-05-06 15:06:39 由 王单爆 操作, 通过数据采集，移送到产品中心】<br/>2: 【于 2017-05-06 15:08:13 由 王单爆 操作, 修改了商品信息】', '2', null, null, '5', '2017-05-06 15:06:39', '2017-05-06 15:08:13', 'L', '粉红色', null);
...
INSERT INTO `product_image` VALUES ('110', '26', 'https://www.guphotos.com/images/H/H10596P/H10596P-5-7cf0.jpg');
INSERT INTO `product_image` VALUES ('111', '26', 'https://www.guphotos.com/images/H/H10596P/H10596P-4-7cf0.jpg');
INSERT INTO `product_image` VALUES ('112', '26', 'https://www.guphotos.com/images/H/H10596P/H10596P-3-7cf0.jpg');
INSERT INTO `product_image` VALUES ('113', '25', 'https://www.guphotos.com/images/H/H10596W/H10596W-7-04e1.jpg');
INSERT INTO `product_image` VALUES ('114', '25', 'https://www.guphotos.com/images/H/H10596W/H10596W-4-04e1.jpg');
INSERT INTO `product_image` VALUES ('115', '25', 'https://www.guphotos.com/images/H/H10596W/H10596W-3-04e1.jpg');
INSERT INTO `product_image` VALUES ('116', '25', 'https://www.guphotos.com/images/H/H10596W/H10596W-5-04e1.jpg');
INSERT INTO `product_image` VALUES ('121', '28', 'https://www.guphotos.com/images/D/D2262S/D2262S-5-b005.jpg');
INSERT INTO `product_image` VALUES ('122', '28', 'https://www.guphotos.com/images/D/D2262S/D2262S-3-b005.jpg');
INSERT INTO `product_image` VALUES ('123', '28', 'http://139.162.109.79:8082/images/170422/H0bxGZGDbKs2tutz.jpg');
INSERT INTO `product_image` VALUES ('124', '29', 'https://cbu01.alicdn.com/img/ibank/2017/636/892/3966298636_1619311604.jpg');
INSERT INTO `product_image` VALUES ('133', '38', 'https://cbu01.alicdn.com/img/ibank/2017/636/892/3966298636_1619311604.jpg');
INSERT INTO `product_image` VALUES ('135', '39', 'https://cbu01.alicdn.com/img/ibank/2017/636/892/3966298636_1619311604.jpg');
INSERT INTO `product_image` VALUES ('164', '27', 'https://www.guphotos.com/images/H/H10596R/H10596R-4-6290.jpg');
INSERT INTO `product_image` VALUES ('165', '27', 'https://www.guphotos.com/images/H/H10596R/H10596R-6-6290.jpg');
INSERT INTO `product_image` VALUES ('166', '27', 'https://www.guphotos.com/images/H/H10596R/H10596R-3-6290.jpg');
INSERT INTO `product_image` VALUES ('167', '27', 'https://www.guphotos.com/images/H/H10596R/H10596R-1-6290.jpg');
...
-- ----------------------------
INSERT INTO `shopee_publish` VALUES ('1', 'DV3', 'Y2639', null, null, null, '照片', null, null, '0.002', null, null, null, '5', '2', 'http://www.guphotos.com/images/D/D1816W-EU/D1816W-EU-4-375a.jpg', null);
INSERT INTO `shopee_publish` VALUES ('2', 'Y2639BL', 'Y2639', null, null, null, 'CAMP607移动式侧板滑轮', null, null, '0.001', null, null, '', '5', '2', 'http://www.guphotos.com/images/Y/L/Y2639BL/Y2639BL-1-d704-KP3L.jpg', null);
INSERT INTO `shopee_publish` VALUES ('3', 'W3770-X', 'W3770', '64mm', 'Accessories > Belts > Men', '7122', '路亚硬饵 DW21 喷红头 熊王系列长舌板 64mm 16.5g', '3', '7', '23', '3', null, '234', '5', '2', 'https://www.guphotos.com/images/H/H10596W/H10596W-7-04e1.jpg', '[\"https://www.guphotos.com/images/H/H10596W/H10596W-7-04e1.jpg\",\"https://www.guphotos.com/images/H/H10596W/H10596W-4-04e1.jpg\",\"https://www.guphotos.com/images/H/H10596R/H10596R-4-6290.jpg\",\"https://www.guphotos.com/images/H/H10596R/H10596R-6-6290.jpg\"]');
INSERT INTO `shopee_publish` VALUES ('4', 'W3770-T', 'W3770', '64mm', 'Accessories > Belts > Men', '7122', '路亚硬饵 DW21 喷红头 熊王系列长舌板 64mm 16.5g', '2', '6', '23', '3', null, '234', '5', '2', 'https://www.guphotos.com/images/H/H10596W/H10596W-7-04e1.jpg', '[\"https://www.guphotos.com/images/H/H10596W/H10596W-7-04e1.jpg\",\"https://www.guphotos.com/images/H/H10596W/H10596W-4-04e1.jpg\",\"https://www.guphotos.com/images/H/H10596R/H10596R-4-6290.jpg\",\"https://www.guphotos.com/images/H/H10596R/H10596R-6-6290.jpg\"]');
INSERT INTO `shopee_publish` VALUES ('5', 'W3770-23', 'W3770', '64mm', 'Accessories > Belts > Men', '7122', '路亚硬饵 DW21 喷红头 熊王系列长舌板 64mm 16.5g', '5', '5', '23', '3', null, '234', '5', '2', 'https://www.guphotos.com/images/H/H10596W/H10596W-7-04e1.jpg', '[\"https://www.guphotos.com/images/H/H10596W/H10596W-7-04e1.jpg\",\"https://www.guphotos.com/images/H/H10596W/H10596W-4-04e1.jpg\",\"https://www.guphotos.com/images/H/H10596R/H10596R-4-6290.jpg\",\"https://www.guphotos.com/images/H/H10596R/H10596R-6-6290.jpg\"]');
INSERT INTO `shopee_publish` VALUES ('6', 'W3770-A', 'W3770-A', null, null, null, '路亚硬饵 DW21 黑红色 熊王系列长舌板 64mm 16.5g', null, null, '0.003', null, null, 'CADeN 可折叠牛津布内胆包 单反相机内胆包 小号', '5', '2', 'https://www.guphotos.com/images/D/D2262S/D2262S-5-b005.jpg', null);
